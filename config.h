...
static char normbgcolor[]           = "#d2cbb6"; // bar color of title and inactive tab
...
static Key keys[] = {
	...
	{ MODKEY,			XK_BackSpace,		spawn,		SHCMD("xdotool key Caps_Lock") },
	...
	// { MODKEY,			XK_Caps_Lock,	spawn,	SHCMD("") },
	// { MODKEY|ShiftMask,		XK_Caps_Lock,	spawn,	SHCMD("") },
	...
	{ MODKEY,			XK_c,		spawn,		SHCMD("cherrytree") },
	...
	{ MODKEY,			XK_F10,		spawn,		SHCMD("mpv --no-cache --no-osc --no-input-default-bindings --profile=low-latency --input-conf=/dev/null --title=webcam $(ls /dev/video[0,2,4,6,8] | tail -n 1)") },
	{ MODKEY,			XK_F11,		spawn,		SHCMD("$SCRIPTS/colemak-layout-switch.sh") },
	// { MODKEY,			XK_F12,		spawn,		SHCMD("remaps & notify-send \\\"⌨️ Keyboard remapping...\\\" \\\"Re-running keyboard defaults for any newly plugged-in keyboards.\\\"") },
	{ MODKEY,			XK_space,	zoom,		{0} },
	{ MODKEY|ShiftMask,		XK_space,	togglefloating,	{0} },

	{ 0,				XK_Print,	spawn,		SHCMD("maim pic-full-$(date '+%y%m%d-%H%M-%S').png") },
	{ ShiftMask,			XK_Print,	spawn,		SHCMD("maim --select pic-select-$(date '+%y%m%d-%H%M-%S').png") },
	...
	{ ControlMask|ShiftMask, XF86XK_AudioRaiseVolume,	spawn,	SHCMD("pamixer --allow-boost -i 1; kill -44 $(pidof dwmblocks)") },
	{ 0, XF86XK_AudioLowerVolume,	spawn,		SHCMD("pamixer --allow-boost -d 5; kill -44 $(pidof dwmblocks)") },
	{ ShiftMask, XF86XK_AudioLowerVolume,	spawn,	SHCMD("pamixer --allow-boost -d 10; kill -44 $(pidof dwmblocks)") },
	{ ControlMask|ShiftMask, XF86XK_AudioLowerVolume,	spawn,	SHCMD("pamixer --allow-boost -d 1; kill -44 $(pidof dwmblocks)") },
	...
	{ 0, XF86XK_Sleep,		spawn,		SHCMD("$SCRIPTS/i3lock.sh & (sleep 1 && xset dpms force off)") },
	{ 0, XF86XK_WWW,		spawn,		SHCMD("$BROWSER") },
	{ 0, XF86XK_DOS,		spawn,		SHCMD(TERMINAL) },
	{ 0, XF86XK_ScreenSaver,	spawn,		SHCMD("$SCRIPTS/i3lock.sh & xset dpms force off") },
	{ 0, XF86XK_TaskPane,		spawn,		SHCMD(TERMINAL " -e htop") },
	{ 0, XF86XK_Mail,		spawn,		SHCMD(TERMINAL " -e neomutt ; pkill -RTMIN+12 dwmblocks") },
	{ 0, XF86XK_MyComputer,		spawn,		SHCMD(TERMINAL " -e lf /") },
	/* { 0, XF86XK_Battery,		spawn,		SHCMD("") }, */
	{ 0, XF86XK_Launch1,		spawn,		SHCMD("xset dpms force off") },
	{ 0, XF86XK_WebCam,		spawn,		SHCMD("$SCRIPTS/webcam-snapshot.sh") },
	{ 0, XF86XK_Display,		spawn,		SHCMD("$SCRIPTS/dock.sh") },
	{ ShiftMask, XF86XK_WebCam,		spawn,		SHCMD("mpv --no-cache --no-osc --no-input-default-bindings --profile=low-latency --input-conf=/dev/null --title=webcam $(ls /dev/video[0,2,4,6,8] | tail -n 1)") },
	{ 0, XF86XK_TouchpadToggle,	spawn,		SHCMD("(synclient | grep 'TouchpadOff.*1' && synclient TouchpadOff=0) || synclient TouchpadOff=1") },
	{ 0, XF86XK_TouchpadOff,	spawn,		SHCMD("synclient TouchpadOff=1") },
	{ 0, XF86XK_TouchpadOn,		spawn,		SHCMD("synclient TouchpadOff=0") },
	{ 0, XF86XK_MonBrightnessUp,	spawn,		SHCMD("xbacklight -inc 10") },
	{ ShiftMask, XF86XK_MonBrightnessUp,	spawn,		SHCMD("xbacklight -inc 20") },
	{ 0, XF86XK_MonBrightnessDown,	spawn,		SHCMD("xbacklight -dec 10") },
	{ ShiftMask, XF86XK_MonBrightnessDown,	spawn,		SHCMD("xbacklight -dec 20") },
